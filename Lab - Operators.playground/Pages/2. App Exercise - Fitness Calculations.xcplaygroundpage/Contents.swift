...
print(averageHRD)
print("It is different from the averageHR, because we set heartRateDs into double type values, which made it has decimals.")
/*:
...
print("Your have finished", percentOfGoal, "percent of your daily step goal.")
