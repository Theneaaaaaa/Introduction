 ...
 */
let heart_beat1:Double = 64
let heart_beat2:Double = 78
let heart_beat3:Double = 97
let average_heart_beat = (heart_beat1 + heart_beat2 + heart_beat3) / 3
print(average_heart_beat)
/*:
